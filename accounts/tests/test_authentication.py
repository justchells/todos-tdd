...
from accounts.authentication import (
    PersonaAuthenticationBackend, PERSONA_VERIFIER_URL, DOMAIN
)
...
class AuthenticateTest(TestCase):
    ...
    def test_sends_authentication_to_mozilla_with_domain(self, mock_post):
